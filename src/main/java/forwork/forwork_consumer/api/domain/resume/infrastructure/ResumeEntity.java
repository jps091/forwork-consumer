package forwork.forwork_consumer.api.domain.resume.infrastructure;
...
import forwork.forwork_consumer.api.domain.resume.infrastructure.enums.ResumeStatus;
import forwork.forwork_consumer.api.domain.user.UserEntity;
